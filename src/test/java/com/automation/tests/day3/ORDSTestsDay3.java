...
public class ORDSTestsDay3 {
    ...
    public void test4() {
        ...
        //in JSON, employee looks object that consists of param and their values
        ...
        //since first Employee it's a map(key-value pair, we can iterate through it by using Entry.entry represent one key value pair)
        //put ? as value (Map<String, ?>),because there are values of different data type: string, integer, etc..
        ...
        //items it's an obj.whenever you need to read some property from the ojbect, you put object.property
