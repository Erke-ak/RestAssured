...
// * When users sends a GET request to "/search"
//            * And query parameter is 'Las'
//            * Then user verifies that payload  has location_type City
@Test
@DisplayName("Verify that payload has location_type City")
    public void test4(){
        given().
                accept(ContentType.JSON).
                queryParam("query","Las").
...
// * |World Weather Online|
 @Test
 @DisplayName("Verify that payload contains weaher forecast sources")
 public void test5(){
        List<String>expected = Arrays.asList("BBC","Forecast.io","HAMweather","Met Office","OpenWeatherMap","Weather Underground","World Weather Online");
        Response response =given().
                accept(ContentType.JSON).
